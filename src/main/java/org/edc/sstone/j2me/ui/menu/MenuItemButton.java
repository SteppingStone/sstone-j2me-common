 ...
 */
public class MenuItemButton extends MenuButton {

    public final MenuItem menuItem;

    public MenuItemButton(DeviceScreen screen, MenuItem menuItem, byte pos) {
        super(screen, pos);
        this.menuItem = menuItem;
    }

    public void paint(Graphics g, Theme theme, int screenWidth) {
        paintButton(g, menuItem, theme, screenWidth);
    }

    public boolean keyPressed(KeyCode keyCode) {
        return sendMenuEvent(menuItem);
    }
